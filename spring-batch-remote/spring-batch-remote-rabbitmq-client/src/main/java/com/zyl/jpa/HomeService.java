...
public class HomeService{
	...
	public void d() throws Exception{
		...
		DataSourceHolder.setCustomeType("dataSource2");

		((HomeService) AopContext.currentProxy()).f();  
	}
    
    @Transactional(rollbackFor =Exception.class,propagation=Propagation.REQUIRES_NEW)
   	public void f() throws Exception{

   		/*List<ZylGomeTest> list= zYLGomeTestRepository.findAll();
   		
	   		for (ZylGomeTest zylGomeTest : list) {
	   			System.out.println(zylGomeTest);
	   		}
         */
    ...
    public void d1() throws Exception{
    	...
    	ZylGomeTest t1 = em.find(ZylGomeTest.class, "1");
    	t1.setName("aaaa");
    	em.merge(t1);
    	//em.flush();
   	}
    ...
    public void q999() throws Exception{

   		List<ZylGomeTest> list= zYLGomeTestRepository.findAll();
   		
   		for (ZylGomeTest zylGomeTest : list) {
   			zylGomeTest.setName("666");
   			zYLGomeTestRepository.save(zylGomeTest);
   		}   		
